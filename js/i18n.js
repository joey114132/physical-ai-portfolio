    ...
    projects: {
        ...
        media: [
          {
            ...
            caption: "End-to-end run — gate, tower, billing (team deck)",
          },
          {
            type: "video",
            src: "assets/iot/image69.webm",
            caption: "Tower control UI — plate assign & lift log",
          },
          {
            type: "gif",
            src: "assets/iot/gate.gif",
            caption: "Entry gate — barrier open/close",
          },
          {
            type: "gif",
            src: "assets/iot/image40.gif",
            caption: "LPR enter / exit validation UI",
          },
          {
            type: "gif",
            src: "assets/iot/image57.gif",
            caption: "PyQt6 SMART PARKING admin dashboard",
          },
          {
            type: "image",
            src: "assets/iot/pyqt-cam-capture.jpg",
            caption: "ESP32-CAM UDP preview in PyQt (repo capture)",
          },
          {
            type: "image",
      ...
      ros: {
        ...
        visualAids: [
          ...
          {
            type: "diagram",
            src: "assets/shop/mart-floor.png",
            title: "Mart demo floor",
            caption: "Miniature store layout (team presentation).",
          },
        ],
        ...
        media: [
          ...
          },
          {
            ...
            caption: "LLM product search on mart map",
          },
          {
            type: "video",
            src: "PRISMIC_SHOP_SHOPPING_LIST",
            caption: "Shopping-list pick route",
          },
          {
            type: "video",
          ...
          },
          {
            ...
            caption: "Checkout station demo",
          },
          {
            type: "video",
            src: "PRISMIC_SHOP_RETURN",
            caption: "Return-to-base after checkout",
          },
          { type: "gif", src: "PRISMIC_SHOP_REGISTER", caption: "Cart start — QR register & owner lock" },
          { type: "gif", src: "PRISMIC_TRACKING_START", caption: "Tracking session start" },
          { type: "image", src: "assets/shop/robot.png", caption: "Pinky Pro — Basket Edition" },
          { type: "image", src: "assets/shop/mart-floor.png", caption: "Miniature mart demo floor" },
          { type: "image", src: "assets/shop/mart-map.png", caption: "Mart zone map" },
        ],
      },
      pai: {
    ...
    projects: {
      dl: {
        ...
        highlights: [
          ...
          "**PyQt6** UI, 실시간 피드, 모드, **워커 스레드를** 구현했습니다",
          "**LSTM 데이터셋** 상당 부분을 수집·정리했고 **일부를 직접 학습**했습니다",
          "최종 발표에서 **평균 정확도를 약 74%**(**LSTM v1→v4**)를 달성했습니다",
        ],
        brief:
          "웹캠 제스처로 **PPT·YouTube를** 핸즈프리 조작 — **MediaPipe**·**LSTM**·**PyQt6**, **쥐 미로** 게임 모드 포함.",
        whyJoined:
          "팀이 꾸려지기전에 저는 이러한 간단한 손동작을 웹캠만으로 **핸즈프리** 제어를 하고 싶었습니다. **PyQt 데스크톱 셸으로** **웹캠→LSTM→pynput을** 한 화면에 묶고, **LSTM 데이터셋을** 정리하며, 추론 중에도 **UI가 멈추지 않게** 워커 스레드를 나누는걸 활용해보고 싶었습니다.",
        myWork: [
          "**PyQt6 워커 스레드** 구조 구현",
          "**MediaPipe → LSTM → pynput** 파이프라인",
          "**LSTM 데이터셋** **6,276** 시퀀스",
          "**Rat Labyrinth** 쥐 미로 게임 제작",
        ],
        summary:
          "웹캠 제스처로 **PPT·YouTube를** 핸즈프리 조작 — **MediaPipe**·**LSTM**·**PyQt6**, **쥐 미로** 게임 모드 포함.",
        rolePoints: [
        ...
        contributions: [
          ...
          "**MediaPipe + LSTM**를 활용해 Gesture 와 Posture를 구분해서 데이터수집 및 훈련을 진행하여습니다.",
          "**PyQt6 UI**에 웹캠, 모드, 게이지를 넣고 **워커 스레드로** 응답속도를 높였습니다.",
          "**LSTM 데이터셋** `.npy`(**30(프레임)×21(손관절)×3(x,y,z)**) 그리고 수집 툴을 정리했습니다.",
      ...
      iot: {
        ...
        highlights: [
          "실물 주차장에 **로타리 주차 타워**, **ESP32-CAM**, 게이트, 리프트를 연동했습니다",
          "프로젝트 초반에는 **UDP/TCP** 다중 CAM GUI, **33바이트 패킷**, 주차 안내 **펌웨어를** 담당했습니다",
          "프로젝트 후반에는 **PyQt 관제**에서 **PaddleOCR LPR** 창, 클라이언트 UI, **웹캠** 안정화를 맡았습니다",
          "OCR 번호판 인식율을 **~94.3%**, **Test Case들 통과**, 리프트 오차범위 **±2 mm**를 확인했습니다",
        ],
        brief:
          "미니 **회전식 스마트 주차 타워** — **ESP32 3대**, **LPR**, **PyQt6** 관제실로 입출차·결제까지 운영.",
        whyJoined:
          "IoT 2조는 회전 주차 **실물 모형**에 **ESP32 3대**와 **FastAPI가** 동시에 붙는 팀이었습니다. 주차 타워가 어떻게 제어되는지 많이 궁금해서 이 팀을 선택했습니다. 저는 **33바이트 TCP로** 타워 상태를 읽고 **PyQt 관제실**에 뿌리는 통합을 맡고 싶었고, 후반 관제 일정이 밀리자 제가 **IR 안내 펌웨어**, **멀티캠 UI**, **LPR 검증 창**까지 이어서 데모를 살렸습니다.",
        myWork: [
          "**ESP32** 주차 안내 펌웨어 — **33바이트** 패킷, **UDP/TCP**",
          "**PyQt6** 관제실 — 다중 웹캠, **LPR** 창, 게이트 UI",
          "자동차 번허판 인식율 **LPR ~94.3%**",
        ],
        summary:
        ...
        obstacles: [
          ...
          {
            title: "**LPR** 각도 틀림",
            body: "스냅샷 확인·수동 입력으로 보완했고, LPR 인식율 **~94%** 확인했습니다.",
          },
        ],
        outcomes: [
          "미니 로트 **입차→주차→요금→출차** 데모를 완료했습니다.",
          "팀 **Test Case** PASS와 기술 보고서 **Test Report** 확보했습니다.",
          "아래 갤러리에 실물 프로토타입과 팀 덱을 정리했습니다.",
        ],
        visualAids: [
          {
            type: "flow",
          ...
          },
          {
            ...
            src: "assets/iot/deck-overview.png",
            title: "3계층 구조",
            caption: "팀 발표 — PyQt6 / FastAPI / ESP32·Arduino.",
          },
          {
            type: "diagram",
            src: "assets/iot/deck-architecture.png",
            title: "DB 설계",
            caption: "MySQL 14테이블 — USER, PARKING_SLOT, LIFT, DEVICE/LOG.",
          },
        ],
        stack: [
          "ESP32-CAM",
        ...
        media: [
          {
            type: "video",
            src: "assets/iot/image70.webm",
            caption: "입차→출차 통합 리허설 (팀 덱)",
          },
          {
            type: "video",
            src: "assets/iot/image69.webm",
            caption: "타워 제어 UI — 차판 배정·리프트 로그",
          },
          {
            type: "gif",
            src: "assets/iot/gate.gif",
            caption: "입구 게이트 — 차단기 개폐",
          },
          { type: "gif", src: "assets/iot/image40.gif", caption: "LPR 입·출차 검증 UI" },
          {
            type: "gif",
            src: "assets/iot/image57.gif",
            caption: "PyQt6 SMART PARKING 관제 대시보드",
          },
          {
            type: "image",
            src: "assets/iot/pyqt-cam-capture.jpg",
      ...
      ros: {
        ...
        highlights: [
          "미니 마트에서 **Pinky Pro**의 **Owner 추적** 데모를 시연했습니다",
        ...
        techniques: [
          ...
          "**Safe-ID** 동안 **ReID** 생략해 지연율을 줄였습니다.",
          "**NCNN** 온디바이스 추론을 실험했습니다.",
        ],
        obstacles: [
          {
        ...
        outcomes: [
          ...
          "**shoppinkki** 인식 파트를 정리했습니다.",
          "온디바이스용 **NCNN** 파일을 남겼습니다.",
        ],
        visualAids: [
          {
            type: "flow",
          ...
          },
          {
            ...
            src: "assets/shop/software-architecture.png",
            title: "소프트웨어 아키텍처",
            caption: "Confluence — Control Service, shoppinkki · pinky_pro ROS 패키지.",
          },
          {
            type: "diagram",
            src: "assets/shop/hardware-architecture.png",
            title: "하드웨어 아키텍처",
            caption: "Confluence — CartRobotBoard, LiDAR, Dynamixel, LCD.",
          },
          {
            type: "diagram",
            src: "assets/shop/mart-floor.png",
            title: "마트 데모 환경",
            caption: "팀 발표 — 미니어처 매장 배치.",
          },
        ],
        ...
        media: [
          ...
          { type: "video", src: "PRISMIC_SHOP_LLM_GUIDE", caption: "LLM 상품 검색 · 맵 연동" },
          {
            type: "video",
            src: "PRISMIC_SHOP_SHOPPING_LIST",
            caption: "쇼핑 리스트 픽업 경로",
          },
          { type: "video", src: "PRISMIC_SHOP_WAITING", caption: "대기 구역 — 고객 인계" },
          { type: "video", src: "PRISMIC_SHOP_PAYMENT", caption: "결제·체크아웃 스테이션" },
          { type: "video", src: "PRISMIC_SHOP_RETURN", caption: "결제 후 복귀 주행" },
          { type: "gif", src: "PRISMIC_SHOP_REGISTER", caption: "카트 시작 — QR 등록 · Owner 락" },
          { type: "gif", src: "PRISMIC_TRACKING_START", caption: "추적 세션 시작" },
          { type: "image", src: "assets/shop/robot.png", caption: "Pinky Pro — Basket Edition" },
          { type: "image", src: "assets/shop/mart-floor.png", caption: "미니어처 마트 데모 환경" },
          { type: "image", src: "assets/shop/mart-map.png", caption: "매장 구역 맵" },
        ],
      },
      pai: {
        phase: "04 · Physical AI",
        ...
        highlights: [
          "**뎁스 하이파이브**에서 손 3D → **TRAC-IK**로 오차값을 **~20–28cm → ~2cm**까지 줄였습니다",
          "**MuJoCo 트윈** 검증 후 실물 **OpenArm** 데모를 시연했습니다",
          "**Vue + Three.js**로 **D435** 포인트클라우드, 등하원, 율동 UI를 구현했습니다",
          "최종 **Q&A** 페이지(등하원·**무궁화**·Report)를 작성했습니다",
        ],
        brief:
        ...
        myWork: [
          ...
          "**Vue 3 + Three.js** — **D435** zstd WS",
        ],
        summary:
          "유치원 보조 **pingdergarten** — **하이파이브**, **등하원**, **무궁화** 율동까지 **브라우저**에서 돌아가는 **OpenArm** + **Vue/Three.js** + **ROS 2**.",
        rolePoints: [
          "**하이파이브** 폐루프와 **무궁화** 게임·율동 재생을 맡았습니다",
          "**뎁스 WS**, **MediaPipe** 손, **TRAC-IK** 잔차 보정을 구현했습니다",
          "**등하원**·**OX** UI와 최종 **Q&A** 페이지(등하원·무궁화·포털)를 작성했습니다",
        ],
        contributions: [
          "**하이파이브**에 **D435** zstd WS → **포인트클라우드** → **TRAC-IK** + **FK 오차** 루프를 넣었습니다.",
          "좌팔 **IK 미러 솔브**(우측 **TRAC-IK** 그룹) 추가했습니다.",
          "**Vue3 + Three.js**에 **URDF GLB**",
        ...
        visualAids: [
          ...
          },
          {
            ...
            src: "assets/ping/software-architecture.png",
            title: "소프트웨어 아키텍처",
            caption: "Confluence — Portal, Control/AI 서비스, EduPing · GogoPing · NoriArm.",
          },
          {
            type: "diagram",
            src: "assets/ping/hardware-architecture.png",
            title: "하드웨어 아키텍처",
            caption: "Confluence — OpenArm, Vic Pinky, OMX 보드·센서.",
          },
          {
            type: "diagram",
            src: "PRISMIC_CLOUD",
