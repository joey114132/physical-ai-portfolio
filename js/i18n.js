...
export const STRINGS = {
  en: {
    ...
    nav: {
      ...
      hintTouch: "Move pad · Open button · projects in menu (≡)",
      mobileInteract: "Open",
    ...
    intro: {
      ...
      touchNote: "Mobile: **move pad** bottom-left · **Open** bottom-right · pick projects in **menu (≡)**",
  ...
  ko: {
    ...
    nav: {
      ...
      hintTouch: "이동 패드 · 열기 버튼 · 프로젝트는 메뉴(≡)",
      mobileInteract: "열기",
    ...
    intro: {
      ...
      touchNote: "모바일: 왼쪽 **이동 패드** · 오른쪽 **열기** 버튼 · 프로젝트는 **메뉴(≡)** 에서 선택해 주세요",
